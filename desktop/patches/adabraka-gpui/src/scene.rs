...
pub(crate) struct Quad {
    ...
    // Padding to match the WGSL Quad struct size (168 bytes).
    // WGSL Quad has align=8 due to Bounds containing vec2<f32>, which rounds
    // the 164-byte field sum up to 168. This field is never read by shaders.
    pub _shader_pad: u32,
}
...
pub(crate) struct Shadow {
    ...
    pub color: Hsla,
    pub inset: u32,
    pub _shader_pad: u32, // pad to 80 bytes: WGSL align=8 rounds 76→80
}
